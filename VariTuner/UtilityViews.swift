...
extension View {
    @ViewBuilder
    func wrappedInNavigationViewToMakeDismissable(_ dismiss: (() -> Void)?) -> some View { // simple view extensions don't have to conform to ViewModifier
...
//        if compact {
//            // return a single button with a context menu containing target
//            Button {
//
//            } label: {
